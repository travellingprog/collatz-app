    ...
    <Box>
      <Container maxWidth="lg" sx={{ marginY: { xs: 4, sm: 8 } }}>
        ...
        <Paragraph isMobile={isMobile}>
          ...
          conjecture involves a sequence where you start at a number. To find
          the next number, you multiply it by 3 and add 1 when the number is
          odd, or you divide it by 2 if the number is even, and then repeat the
          process with the next number. The conjecture is that no matter what
          positive number you begin with, you will always eventually reach the
          loop of 1, 4, 2, 1.
        </Paragraph>
        <Paragraph isMobile={isMobile}>
          ...
          addition can be any number instead of just +1, and the multiplier can
          be any number, not just -1.
        </Paragraph>
        <Paragraph isMobile={isMobile}>
